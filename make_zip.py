...
# ==============================================================================
# 1. MAIN.PY (Fixed: Passes 'target_map' to template)
# ==============================================================================
file_main_py = """import os
import sqlite3
import re
import math
import json
...
zip_filename = "reef_fix_map.zip"

print(f"Creating {zip_filename} with fixed main.py...")
with zipfile.ZipFile(zip_filename, 'w') as zipf:
    for filename, content in files_to_zip.items():
        zipf.writestr(filename, content)
        print(f"  Added: {filename}")

print("\\nDone! reef_fix_map.zip created.")
