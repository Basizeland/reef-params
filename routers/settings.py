...
def parameter_save(param_id: Optional[str] = Form(None), name: str = Form(...), unit: Optional[str] = Form(None), active: Optional[str] = Form(None), max_daily_change: Optional[float] = Form(None), db: Session = Depends(get_db)):
...
def parameter_delete(param_id: int, db: Session = Depends(get_db)):
...
def test_kit_delete(kit_id: int, db: Session = Depends(get_db)):
...
def additive_save(additive_id: Optional[str] = Form(None), name: str = Form(...), parameter: str = Form(...), strength: float = Form(...), unit: str = Form(...), db: Session = Depends(get_db)):
...
def additive_delete(id: int, db: Session = Depends(get_db)):
